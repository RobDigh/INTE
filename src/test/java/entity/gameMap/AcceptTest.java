...
public class AcceptTest extends GameMapTest {
    ...
    private Creature player = new Creature(135, 1, 6, 5, 7, true, mockInventoryFactory, mockBehaviour);
    private Creature monster = new Creature(125, 1, 7, 5, 6, false, mockInventoryFactory, mockBehaviour);
